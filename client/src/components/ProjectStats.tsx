const ProjectStats = () => {
  const stats = [
    ...
    {
      number: "4",
      label: "Типа упражнений",
      description: "Пропущенные буквы, выбор ответа, сборка слов, поиск рифм"
    },
    {
      number: "3",
      label: "Адаптированных текста",
      description: "Примеры из учебников биологии, математики и астрономии"
    },
    {
      number: "1",
      label: "Специальный шрифт",
      description: "OpenDyslexic для улучшения читаемости"
    }
  ];
